...
const addOne = (arr) => {
  ...
  numArray.forEach( (value) => newArray.push( value + 1) );
...
const addExclamation = (arr) => {
  let wordArray = ['hi', 'how', 'are', 'you'];
  let newWordArray = [];

  wordArray.forEach( (value) => newWordArray.push( value + '!') );
...
const allUpperCase = (arr) => {
  ...
  wordArray.forEach( (value) => newWordArray.push( value.toUpperCase() ) );
...
const speaker = (words, callback) => {
  let speakers = ['HELLO!', '301!', 'STUDENTS!'];
  let newSpeakers = [];
